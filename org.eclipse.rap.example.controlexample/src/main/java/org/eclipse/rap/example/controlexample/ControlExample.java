      ...
      try {
        if (images == null) {
          ...
          for (int i = 0; i < imageLocations.length; ++i) {
            ...
            images[i] = Display.getCurrent().getSystemImage(SWT.IMAGE_COPY);
...
//    gc.dispose();
  ...
  int getDefaultStyle() {
    ...
    //  return SWT.LEFT_TO_RIGHT; [ib] Unsupported
    }
    if (rtlButton != null && rtlButton.getSelection()) {
    //  return SWT.RIGHT_TO_LEFT; [ib] Unsupported
    }
    return SWT.NONE;
  }
  ...
  void log(Event event) {
    ...
    case SWT.MouseDown:
    case SWT.MouseUp:
  //  case SWT.MouseMove: [ib] Unsupported
  //  case SWT.MouseEnter: [ib] Unsupported
  //  case SWT.MouseExit: [ib] Unsupported
    case SWT.MouseDoubleClick:
  //  case SWT.MouseWheel: [ib] Unsupported
  //  case SWT.MouseHover: [ib] Unsupported
    ...
    case SWT.Collapse:
      ...
      break;
    //case SWT.Iconify: [ib] Unsupported
    //case SWT.Deiconify: [ib] Unsupported
    case SWT.Close:
    case SWT.Activate:
    case SWT.Deactivate:
    ...
    case SWT.Traverse:
      ...
      break;
   // case SWT.HardKeyDown: [ib] Unsupported
   // case SWT.HardKeyUp: [ib] Unsupported
    case SWT.DragDetect:
    case SWT.MenuDetect:
    default:
      toString += event.toString();
...
class MenuTab extends Tab {
  ...
  public void createButtonSelected(SelectionEvent event) {
    ...
    if (rightToLeftButton.getSelection())
      //orientation |= SWT.RIGHT_TO_LEFT; [ib] Unsupported
      orientation |= SWT.LEFT_TO_RIGHT;
    int radioBehavior = 0;
